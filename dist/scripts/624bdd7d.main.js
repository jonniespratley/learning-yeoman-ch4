...
define('views/about',['jquery', 'underscore', 'backbone', 'templates'], function($, _, Backbone, JST) {
  var AboutView, _ref;
  return AboutView = (function(_super) {
    ...
    AboutView.prototype.template = JST['app/scripts/templates/about.hbs'];
...
define('models/post',['underscore', 'backbone'], function(_, Backbone) {
  'use strict';
  var PostModel, _ref;
  return PostModel = (function(_super) {
    ...
    function PostModel() {
      _ref = PostModel.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    PostModel.prototype.idAttribute = '_id';

    PostModel.prototype.urlRoot = '/api/v2/learning-yeoman-ch3/posts';
    ...
    PostModel.prototype.validate = function(attrs, options) {
      if (attrs.title === '') {
...
define('collections/posts',['underscore', 'backbone', 'models/post'], function(_, Backbone, PostModel) {
  var PostsCollection, _ref;
  return PostsCollection = (function(_super) {
    __extends(PostsCollection, _super);

    function PostsCollection() {
      _ref = PostsCollection.__super__.constructor.apply(this, arguments);
      return _ref;
    }
    ...
    PostsCollection.prototype.parse = function(response) {
...
define('routes/app',['backbone', 'config', 'views/app', 'views/main', 'views/about', 'views/posts', 'views/post', 'views/post-detail', 'views/post-form', 'models/post'], function(Backbone, Config, AppView, MainView, AboutView, PostsView, PostView, PostDetailView, PostFormView, PostModel) {
  ...
  return AppRouter = (function(_super) {
    ...
    AppRouter.prototype.childViews = {};
    ...
    AppRouter.prototype.posts = function() {
    ...
    AppRouter.prototype.postDetail = function(id) {
      var post;
      post = new PostModel({
        _id: id
      });
    ...
    AppRouter.prototype.postEdit = function(id) {
      var post;
      post = new PostModel({
        _id: id
      });
    ...
    AppRouter.prototype.postNew = function() {
    ...
    AppRouter.prototype.showView = function(view) {
      if (this.currentView) {
        this.currentView.close();
      }
      this.currentView = view;
      this.currentView.render();
      return console.log('App.showView', this);
    };
